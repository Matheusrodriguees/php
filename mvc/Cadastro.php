...
<script language="javascript"type="text/javascript">
    ...
    var preco = form.preso.value;
    for (i = 0; i<= formulario.length - 2; i++){
        if((formulario[i].value == "")){
            alert("Preencha o campo "=formulario[i].nome);
            formulario[i].focus();
            return false;
        }
    }
    ...
    if (preco <=0){
        alert('O preço do livro não pode ser igaul oi inferior a 0');
        form.preco.focus();
        return false;
        }
        formulario.submit();
 ...
 <div class="row">
     <formmethod="post"action="../controller/ControllerCadastro.php"id="form"name="form"onsubmit="validar(document.form);returnfalse;"class="col-10">
         <div class="form-group">
             <div class="form-group">
                <div class="mx-auto"style="width:500px;">
                    <label for="nome">Nome do Livro</label>
                    <input class="form-control"type="text"id="nome"name="nome"placeholder="Nome d oLivro"required autofocus>
                    </div>
                </div>
                <div class="form-group">
                    <div class="mx-auto"style="width:500px;">
                    ...
                    <div class="form-group">
                        <div class="mx-auto"style="width:500px;">
                            ...
                            <div class="form-group">
                               <div class="mx-auto"style="width:500px;">
                                   <label for="number">Valor unitário do livro
                                    </label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control"type="date"id="data"name="data"placeholder="Data de Pulicação"required></div>
                                    </div>
